...
const teamPlaceholder = `Lorem ipsum, dolor sit amet consectetur adipisicing elit.
  ...
  exercitationem cumque earum omnis ipsum rem accusantium quis, quas quia,
  accusamus provident suscipit magni!`;
      ...
      <section className="partners-section">
        <div className="partners-container">
          ...
          <div className="sponsor__container grid">
            ...
            <div className="partners__content">
              <img src="/images/sponsors2.png" alt="" className="partners__img" />
            </div>
            <div className="partners__content">
              <img src="/images/google.png" alt="" className="partners__img" />
            </div>
            <div className="partners__content">
              <img src="/images/sponsors4.png" alt="" className="partners__img" />
            </div>
            <div className="partners__content">
              <img src="/images/sponsors5.png" alt="" className="partners__img" />
            </div>
          </div>
        </div>
      </section>
